...
export default function AppNav() {
    ...
    return (
        <header className="sticky top-0 z-50 border-b border-slate-800/80 bg-slate-950/80 shadow-lg shadow-black/20 backdrop-blur-xl supports-[backdrop-filter]:bg-slate-950/70">
            ...
            >
                <Link href="/" className="group flex shrink-0 items-center gap-3 text-slate-100">
                    <span className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-sky-400 to-indigo-600 shadow-lg shadow-sky-950/50 transition-transform group-hover:scale-105">
                        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-5 w-5 fill-none stroke-white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <span><span className="block text-sm font-bold tracking-[0.16em]">AEGIS</span><span className="hidden text-[10px] text-slate-500 sm:block">Risk intelligence</span></span>
                </Link>
